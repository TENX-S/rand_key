...
use crate::{ RandKey, ToRandKey, utils::{ One, _DATA, BigUint, } };
...
impl Add for RandKey {
    ...
    /// let mut r2 = r0 + r1;
    ///
    /// assert_eq!(*r2.get_cnt("L").unwrap(), BigUint::from(5_usize));
    /// assert_eq!(*r2.get_cnt("S").unwrap(), BigUint::from(7_usize));
